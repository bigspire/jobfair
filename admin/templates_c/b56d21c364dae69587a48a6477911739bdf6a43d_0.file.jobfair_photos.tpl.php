<?php
/* Smarty version 3.1.29, created on 2017-01-24 18:53:09
  from "/var/www/html/jobfair_jobfac/admin/templates/jobfair_photos.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5887553d889659_12802710',
  'file_dependency' => 
  array (
    'b56d21c364dae69587a48a6477911739bdf6a43d' => 
    array (
      0 => '/var/www/html/jobfair_jobfac/admin/templates/jobfair_photos.tpl',
      1 => 1485264120,
      2 => 'file',
    ),
  ),
...
function content_5887553d889659_12802710 ($_smarty_tpl) {
if (!is_callable('smarty_function_html_options')) require_once '/var/www/html/jobfair_jobfac/admin/vendor/smarty-3.1.29/libs/plugins/function.html_options.php';
?>
...
<div class="wrapper">
   ...
   <?php }?>
    <!-- Content -->
    <div class="content">
    	<div class="title"><h5>Job Fair Photos</h5>
		...
		<div class="breadCrumb module">
                    <ul>
                        ...
                        <li>List Job Fair Photos</li>
                    </ul>
							<div class="num"><a class="blueNum" href="add_jobfair_photos.php" title="Add Job Fair Photos">Add Job Fair Photos</a></div>
                </div>
		
	
	<form action="jobfair_photos.php" onsubmit="return submit_search(this, &#39;company&#39;)" id="searchFrm" name="searchFrm" method="post" class="" accept-charset="utf-8">
	<div style="display:none;"><input type="hidden" name="_method" value="POST"></div>		
			
	<div class="widget">      
	   	<div class="table">
		
            <div class="head"><h5 class="iFrames">List Job Fair Photos</h5>
		
		<a class="jsRedirect btn14 mr10 mt5" val="jobfair_photos.php" style="float:right" title="" href="jobfair_photos.php"> Reset</a>
...
" autocomplete="off" tabindex="1" id="search">			 	
		<input type="hidden" name="data[Company][webroot]" id="webroot" value="jobfair_photos.php"><input type="hidden" name="data[Company][hdnSubmit]" id="CompanyHdnSubmit">				
         ...
         <div class="dataTables_wrapper" id="example_wrapper"> <table cellspacing="0" cellpadding="0" border="0" id="example" class="display">
            <thead>
              <tr>
					...
					<a href="jobfair_photos.php?field=title&order=<?php echo $_smarty_tpl->tpl_vars['order']->value;?>
...
"></span></div></a></th>
					...
					<th class="ui-state-default" rowspan="1" colspan="1" style="width: 150px;">
					<a href="jobfair_photos.php?field=no_of_photos&order=<?php echo $_smarty_tpl->tpl_vars['order']->value;?>
&page=<?php echo $_GET['page'];?>
&keyword=<?php echo $_smarty_tpl->tpl_vars['keyword']->value;?>
&status=<?php echo $_smarty_tpl->tpl_vars['status']->value;?>
">
...
"></span></div></th>	
					...
					<a href="jobfair_photos.php?field=status&order=<?php echo $_smarty_tpl->tpl_vars['order']->value;?>
&page=<?php echo $_GET['page'];?>
&keyword=<?php echo $_smarty_tpl->tpl_vars['keyword']->value;?>
&status=<?php echo $_smarty_tpl->tpl_vars['status']->value;?>
">
...
"></span></div></a></div></th>
					...
					<a href="jobfair_photos.php?field=created_date&order=<?php echo $_smarty_tpl->tpl_vars['order']->value;?>
&page=<?php echo $_GET['page'];?>
&keyword=<?php echo $_smarty_tpl->tpl_vars['keyword']->value;?>
&status=<?php echo $_smarty_tpl->tpl_vars['status']->value;?>
">
...
"></span></div></a></th>
					...
					<th class="ui-state-default" rowspan="1" colspan="1" style="width: 145px;">
					<a href="jobfair_photos.php?field=modified_date&order=<?php echo $_smarty_tpl->tpl_vars['order']->value;?>
&page=<?php echo $_GET['page'];?>
&keyword=<?php echo $_smarty_tpl->tpl_vars['keyword']->value;?>
&status=<?php echo $_smarty_tpl->tpl_vars['status']->value;?>
">
...
?>
		...
		<input type="hidden" id="page" value="jobfair_photos">		
		<input type="hidden" id="web_root" value="delete_jobfair_photos.php">	
	</div>
	<div class="fix">
	</div>
</form>
