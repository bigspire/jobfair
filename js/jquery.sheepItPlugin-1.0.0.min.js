(function($) {
    jQuery.fn.sheepIt = function(options) {
        ...
        function clickOnRemoveCurrent(event) {
            ...
            if(window.toggle_business_category)
	            toggle_business_category();
        }
