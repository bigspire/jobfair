...
(function($) {
	$.alerts = {
		...
		selectButton: 'cancel',				// default select button
		okBtnClass: 'basicBtn',
		cancelBtnClass: 'blueBtn',
		...
		_show: function(title, msg, value, type, callback) {
			...
			switch( type ) {
				...
				break;
				case 'confirm':
					$("#popup_message").after('<div id="popup_panel"><input type="button" class="'+$.alerts.okBtnClass+'" value="' + $.alerts.okButton + '" id="popup_ok" /> <input type="button" class="'+$.alerts.cancelBtnClass+'" value="' + $.alerts.cancelButton + '" id="popup_cancel" /></div>');
					$("#popup_ok").click( function() {
						$.alerts._hide();
					...
					$("#popup_"+$.alerts.selectButton).focus();
